...
2. В разделе **Узлы** создайте одноразовый грант. Панель один раз покажет и грант, и отдельный публичный адрес агента; передайте их по защищённому каналу в `wdtt-control-panel` версии `0.10.12` или новее.
